      ...
      <header className="bg-white dark:bg-slate-900 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 shadow-sm sticky top-0 z-10 transition-colors">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6 py-3 sm:py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/login"
              className="text-slate-600 dark:text-slate-300 font-medium hover:text-blue-400 transition-colors text-sm sm:text-base"
            >
              Login
            </Link>
          ...
          <div className="p-6 sm:p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 dark:text-slate-400">
                Join Chrono<span className="text-blue-500">HUB</span> and start your leave management journey
              </p>
            </div>
